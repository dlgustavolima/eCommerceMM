...
public class PagamentoCartaoCreditoFacade : IPagamentoFacade
{
    ...
    {
        var nerdsPagSvc = new MMPagService(_pagamentoConfig.DefaultApiKey,
    ...
    public static Transaction ParaTransaction(Transacao transacao, MMPagService florattaPagService)
    {
        return new Transaction(florattaPagService)
        {
